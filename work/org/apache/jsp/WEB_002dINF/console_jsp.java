...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/"; 
      ...
      out.write("\t\t\t<div><a href=\"javascript:tab('客户','customview/viewIndex?entitytype=Accounts')\">客户</a></div>\r\n");
      ...
      out.write("\t\t\t<div><a href=\"javascript:tab('综合报表','integradedreports/index/2012')\" >综合报表</a></div>\r\n");
