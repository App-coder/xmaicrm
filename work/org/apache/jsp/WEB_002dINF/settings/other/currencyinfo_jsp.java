...
public final class currencyinfo_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String win_topbar = "resizable=\"false\"  closed=\"true\" modal=\"true\" collapsible=\"false\"  draggable=\"true\" minimizable=\"false\" maximizable=\"false\" inline=\"false\"";
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("    var pathname = \"货币币种\";\r\n");
      out.write("    var pathActive = \"currencyInfo\";\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("$(function(){\r\n");
      ...
      out.write("\tsrc=\"resources/desktop/settings/other/currencyinfo.js\"></script>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\t\t\t<div id=\"currencyinfo\" class=\"easyui-window\" ");
      out.print(win_topbar);
      out.write("\r\n");
      out.write("\t\t\t\tstyle=\"width: 500px; height: 309px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<form id=\"form_currencyinfo\" name=\"form_currencyinfo\" method=\"post\" >\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"id\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"defaultid\" value=\"0\" />\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"tab_form\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"39%\" class=\"edittd3\">货币名称</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"61%\"><input type=\"text\" name=\"currencyName\" class=\"text3 easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"39%\" class=\"edittd3\">货币编码</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"61%\"><input type=\"text\" name=\"currencyCode\" class=\"text3 easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"39%\" class=\"edittd3\">货币标志</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"61%\"><input type=\"text\" name=\"currencySymbol\" class=\"text3 easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"39%\" class=\"edittd3\">汇率</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"61%\"><input type=\"text\" name=\"conversionRate\" class=\"text3 easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"39%\" class=\"edittd3\">状态</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"61%\"><select name=\"currencyStatus\" class=\"text3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${asOptions }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<a class=\"easyui-linkbutton\" iconCls=\"icon-ok\" onclick=\"formsubmit('form_currencyinfo')\">编辑</a>\r\n");
      out.write("\t\t\t\t\t\t\t<a class=\"easyui-linkbutton\" iconCls=\"icon-cancel\" onclick=\"closeWin('currencyinfo')\">取消</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<table id=\"currencyinfo_list\"></table>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\r\n");
