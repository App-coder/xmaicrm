...
String win_topbar = "resizable=\"false\"  closed=\"true\" modal=\"true\" collapsible=\"false\"  draggable=\"true\" minimizable=\"false\" maximizable=\"false\" inline=\"false\"";
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("var pathname = \"部门机构\";\r\n");
      out.write("var pathActive = \"group\";\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("$(function(){\r\n");
      ...
      out.write("</script>");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\" src=\"resources/desktop/settings/basic/group.js\"></script>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\t<div id=\"groupedit\" class=\"easyui-window\" ");
      out.print(win_topbar);
      out.write(" style=\"width: 400px; height:247px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<form id=\"form_group\" method=\"post\" name=\"form_group\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"action\" />\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"groupid\" />\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"tab_form\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"39%\" class=\"edittd3\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t部门\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"61%\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"groupname\" class=\"text3 easyui-validatebox\" required=\"true\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"39%\" class=\"edittd3\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"61%\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"description\" class=\"text3 easyui-validatebox\" required=\"true\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      ...
      out.write("\t\t\t\t\t\t<a class=\"easyui-linkbutton\" iconCls=\"icon-ok\" onclick=\"formsubmit('form_group')\">编辑</a>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"easyui-linkbutton\" iconCls=\"icon-cancel\" onclick=\"closeWin('groupedit')\">取消</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("\t<table id=\"grouplist\" data-options=\"fitColumns:true\"></table>\r\n");
      out.write("\t</td>\r\n");
      out.write("</tr>\r\n");
      out.write("</table>\r\n");
      out.write("\r\n");
