...
String win_bar_1 = "resizable=\"false\"  closed=\"true\" modal=\"false\" collapsible=\"false\"  draggable=\"true\" minimizable=\"false\" maximizable=\"false\" inline=\"false\"";
      ...
      out.write("    var pathActive = \"users\";\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("$(function(){\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"32%\"><input type=\"text\" class=\"text3 easyui-validatebox\" name=\"email1\" data-options=\"validType:'email'\"  required=\"true\"/></td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">用户名</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"32%\"><input type=\"text\" name=\"userName\" class=\"text3 easyui-validatebox\" required=\"true\" readonly=\"readonly\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">管理员</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"32%\"><input type=\"checkbox\" name=\"isAdmin\"  /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">Email</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"32%\"><input type=\"text\" class=\"text3 easyui-validatebox\" name=\"email1\" data-options=\"validType:'email'\" required=\"true\"/></td>\r\n");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<div id=\"userview\" title=\"用户预览\" class=\"easyui-window\" ");
      out.print(win_topbar);
      out.write(" style=\"width: 600px; height: 370px;\">\r\n");
      out.write("\t\t\t\t<div class=\"easyui-layout\" data-options=\"fit:true,border:false\">\r\n");
      out.write("\t\t\t\t\t<div data-options=\"region:'center',border:false\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">用户名</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><span id=\"userName\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">密码</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><a class=\"easyui-linkbutton\" iconCls=\"icon-edit\" onclick=\"updatePwd()\" >修改密码</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">管理员</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><span id=\"isAdmin\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">状态</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><span id=\"status\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">姓名</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><span id=\"lastName\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">角色</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><span id=\"roleid\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">电话</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><span id=\"phoneWork\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">Email</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><span id=\"email1\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">手机</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><span id=\"phoneMobile\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">部门</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><span id=\"groupid\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</form>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<table class=\"tab_form\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">新密码</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><input type=\"password\" name=\"userPassword\" class=\"text3 easyui-validatebox\" required=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"18%\" class=\"edittd3\">确认密码</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"32%\"><input type=\"password\" name=\"confirmPassword\" class=\"text3 easyui-validatebox\" required=\"true\" /></td>\r\n");
      ...
      out.write("\t\t<li id=\"path_multiapprove\"><a href=\"crm/settings/multiapprove/index\">审批流程</a></li>\r\n");
  ...
  private boolean _jspx_meth_c_005fwhen_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/settings/basic/../../head.jsp(17,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
