package org.apache.jsp.WEB_002dINF.settings.basic.users;
...
public final class detail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/settings/basic/users/../../../head.jsp");
    _jspx_dependants.add("/WEB-INF/settings/basic/users/../../../common/config.jsp");
    _jspx_dependants.add("/WEB-INF/settings/basic/users/../../../path.jsp");
    _jspx_dependants.add("/WEB-INF/settings/basic/users/../../../foot.jsp");
...
String win_topbar = "resizable=\"false\"  closed=\"true\" modal=\"true\" collapsible=\"false\"  draggable=\"true\" minimizable=\"false\" maximizable=\"false\" inline=\"false\"";
      ...
      out.write("\tsrc=\"resources/desktop/settings/basic/users/detail.js\"></script>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\t\t\t<div id=\"editpassword\" title=\"修改密码\" class=\"easyui-window\" ");
      out.print(win_topbar);
      out.write(" style=\"width: 300px; height: 175px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<form id=\"formpass\" name=\"formpass\" method=\"post\"  >\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"id\" id=\"id\" />\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"tab_form\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td  class=\"edittd3\">新密码</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input type=\"password\" name=\"userPassword\" class=\"text3 easyui-validatebox\" required=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td  class=\"edittd3\">确认密码</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input type=\"password\" name=\"confirmPassword\" class=\"text3 easyui-validatebox\" required=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div region=\"south\" class=\"btnbar\" border=\"false\">\r\n");
      out.write("\t\t\t\t\t\t<a class=\"easyui-linkbutton\" iconCls=\"icon-ok\" onclick=\"updatePwdDo()\">编辑</a>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"easyui-linkbutton\" iconCls=\"icon-cancel\" onclick=\"closeWin('editpassword')\">取消</a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t<form name=\"formview\" id=\"formview\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" id=\"id\" />\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"tab_view\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"label\">用户名</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"info\"><span id=\"userName\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"label\">密码</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"info\"><a class=\"easyui-linkbutton\" iconCls=\"icon-edit\" onclick=\"updatePwd()\" >修改密码</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"label\">管理员</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td ><span id=\"isAdmin\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"label\">状态</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td ><span id=\"status\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"label\">姓名</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td ><span id=\"lastName\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"label\">角色</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td ><span id=\"roleid\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"label\">电话</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td ><span id=\"phoneWork\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"label\">Email</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td ><span id=\"email1\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"label\">手机</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td ><span id=\"phoneMobile\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"label\">部门</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td ><span id=\"groupid\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"bbar \">\r\n");
      out.write("\t\t\t\t\t\t\t\t<a class=\"easyui-linkbutton\" iconCls=\"icon-ok\" onclick=\"showupdate()\">编辑</a>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"userName\" class=\"text3 easyui-validatebox\" required=\"true\" readonly=\"readonly\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td  class=\"edittd\">管理员</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"checkbox\" name=\"isAdmin\"  /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td  class=\"edittd\">Email</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" class=\"text3 easyui-validatebox\" name=\"email1\" data-options=\"validType:'email'\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td  class=\"edittd\">状态</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select name=\"status\" class=\"text3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"lastName\" class=\"text3 easyui-validatebox\" required=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td  class=\"edittd\">角色</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input id=\"roleid\" name=\"roleid\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"easyui-combotree\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdata-options=\"url:'crm/settings/role/getRoleTree',required:true\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"width: 190px;\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td  class=\"edittd\">电话</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"phoneWork\" class=\"text3 easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td  class=\"edittd\">手机</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" class=\"text3 easyui-validatebox\" name=\"phoneMobile\" required=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td  class=\"edittd\">部门</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input class=\"easyui-combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"groupid\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdata-options=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\turl:'crm/settings/group/getCombox',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"bbar pl10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<a class=\"easyui-linkbutton\" iconCls=\"icon-ok\" onclick=\"formsubmit('form_edit')\">编辑</a>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\r\n");
      out.write("\t</div>\r\n");
  ...
  private boolean _jspx_meth_c_005fwhen_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/settings/basic/users/../../../head.jsp(16,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
