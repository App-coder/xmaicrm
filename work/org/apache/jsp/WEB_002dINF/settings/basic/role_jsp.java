...
String win_bar_1 = "resizable=\"false\"  closed=\"true\" modal=\"false\" collapsible=\"false\"  draggable=\"true\" minimizable=\"false\" maximizable=\"false\" inline=\"false\"";
      ...
      out.write("\tsrc=\"resources/desktop/settings/basic/role.js\"></script>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<!-- 查看关联用户 -->\r\n");
      out.write("\t\t\t<div id=\"reluser\" title=\"关联的用户\" class=\"easyui-window\" ");
      ...
      out.write("\t\t\t\t\t\t<table id=\"tb_reluser\"></table>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<div id=\"roleinfo\" title=\"编辑角色信息\" class=\"easyui-window\" ");
      out.print(win_topbar);
      out.write("\r\n");
      out.write("\t\t\t\tstyle=\"width: 700px; height: 432px;\">\r\n");
      out.write("\t\t\t\t<div class=\"easyui-layout\" data-options=\"fit:true,border:false\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\turl:'crm/settings/role/getRoleTree',\r\n");
      ...
      out.write("\t\t\t\t<table id=\"rolelist\"></table></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t\t\r\n");
      out.write("\t</div>\r\n");
