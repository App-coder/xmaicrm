...
String win_bar_1 = "resizable=\"false\"  closed=\"true\" modal=\"false\" collapsible=\"false\"  draggable=\"true\" minimizable=\"false\" maximizable=\"false\" inline=\"false\"";
      ...
      out.write("</script>");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\" src=\"resources/desktop/settings/system/picklist.js\"></script>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\t\t\t<div id=\"picklist\" class=\"easyui-window\" ");
      ...
      out.write("\t\t\t\t\t\t<form id=\"form_picklist\" name=\"form_picklist\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"tab_form\" cellpadding=\"5\" celspacing=\"0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr id=\"picklist\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"dataLabel\" valign=\"top\" nowrap=\"nowrap\" align=\"right\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<b>下拉框列表值: </b>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td valign=\"top\" align=\"left\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<textarea class=\"fldPickList\" rows=\"15\" name=\"fldPickList\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      ...
      out.write("\t\t\t\t\t\t<a class=\"easyui-linkbutton\" iconCls=\"icon-ok\" onclick=\"submitPicklist()\">确定</a>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"easyui-linkbutton\" iconCls=\"icon-cancel\" onclick=\"closeWin('picklist')\">取消</a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("    <div class=\"d_view\" id=\"tb\">\r\n");
      out.write("\t\t<span>选择CRM模块:</span>\r\n");
      out.write("\t\t<select class=\"importBox\" name=\"pick_module\"></select>\r\n");
      out.write("\t</div>    \r\n");
      out.write("    <table id=\"picklist_datagrid\" class=\"easyui-datagrid\"\r\n");
