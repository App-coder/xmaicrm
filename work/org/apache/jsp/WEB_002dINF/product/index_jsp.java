...
String win_topbar = "closed=\"true\" modal=\"true\" collapsible=\"false\"  draggable=\"false\" minimizable=\"false\" maximizable=\"false\" inline=\"false\" resizable=\"false\"";
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div data-options=\"region:'center',title:'产品列表'\" style=\"background:#fafafa;overflow:hidden\" >\r\n");
      out.write("\t\t\t<table class=\"easyui-datagrid\" data-options=\"border:false,fit:true,fitColumns:true\">\r\n");
      out.write("\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th data-options=\"field:'itemid'\" width=\"80\">产品名称</th>\r\n");
      out.write("\t\t\t\t\t\t<th data-options=\"field:'productid'\" width=\"100\">产品编码</th>\r\n");
      out.write("\t\t\t\t\t\t<th data-options=\"field:'listprice',align:'right'\" width=\"80\">产品类别</th>\r\n");
      out.write("\t\t\t\t\t\t<th data-options=\"field:'unitcost',align:'right'\" width=\"80\">型号</th>\r\n");
      out.write("\t\t\t\t\t\t<th data-options=\"field:'attr1'\" width=\"150\">供应商名称</th>\r\n");
      out.write("\t\t\t\t\t\t<th data-options=\"field:'status',align:'center'\" width=\"50\">单价</th>\r\n");
      out.write("\t\t\t\t\t\t<th data-options=\"field:'status',align:'center'\" width=\"50\">总库存数量</th>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</thead>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t</div>\r\n");
