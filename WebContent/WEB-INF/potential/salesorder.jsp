...
<script>
    var salesorder_columns = ${dview};
    var salesorder_viewid = ${customview.cvid}
</script>
<script type="text/javascript"
	src="resources/desktop/potential/salesorder.js"></script>
<div class="container">
	<div class="hidden">
		<div id="salesorder_m1" style="width:100px;">
	...
	<div class="easyui-layout" fit="true">
		<div data-options="region:'north',border:false">
			<div class="d_view ">
				...
				<a href="javascript:void(0)" class="easyui-menubutton" data-options="menu:'#salesorder_m1',iconCls:'icon-tool'">管理</a>
			</div>
		</div>
		<div data-options="region:'center',border:false"
			style="overflow: hidden">
			<table id="salesorder_list" data-options="fit:true,fitColumns:true"></table>
		</div>
