	...
	<div class="easyui-layout" fit="true">
		...
		<div data-options="region:'center',border:false"
			...
			<table id="account_list" data-options="fit:true,fitColumns:true">
			     <tr>
					<td align="center">
					<img border="0" src="resources/images/Bsteps/pur_01.jpg"><br>
					<img border="0" src="resources/images/Bsteps/pur_02.jpg"><br>
					<img border="0" usemap="#Map" src="resources/images/Bsteps/pur_03.jpg">
					</td>
					<td></td>
				 </tr>
