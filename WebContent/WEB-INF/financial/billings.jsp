...
<c:choose>
	<c:when test="${customview.cvid!=null && dview!=null}">
		<script>
			var billings_columns = ${dview};
			var billings_viewid = ${customview.cvid};
		</script>
	</c:when>
	<c:otherwise>
		<script>
			var billings_columns = "";
			var billings_viewid = -1;
		</script>
	</c:otherwise>
</c:choose>
...
<div class="container">
	...
	<div class="easyui-layout" fit="true">
		...
		<div data-options="region:'center',border:false"
			...
			<table id="account_list" class="easyui-datagrid" data-options="fit:true,fitColumns:true" toolbar="#billings_tb">
			  <thead>  
		        <tr>  
			...
			<div id="billings_tb" style="padding:1px;height:auto">  
			    <div>  
			                            查看范围:   
