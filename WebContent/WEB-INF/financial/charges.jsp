...
<c:choose>
	<c:when test="${customview.cvid!=null && dview!=null}">
		<script>
			var charges_columns = ${dview};
			var charges_viewid = ${customview.cvid};
		</script>
	</c:when>
	<c:otherwise>
		<script>
			var charges_columns = "";
			var charges_viewid = -1;
		</script>
	</c:otherwise>
</c:choose>

<script type="text/javascript" 	src="resources/desktop/financial/charges.js"></script>
...
<div class="container">
	...
	<div class="easyui-layout" fit="true">
		...
		<div data-options="region:'center',border:false"
			...
			<table id="account_list" class="easyui-datagrid" data-options="fit:true,fitColumns:true" toolbar="#charges_tb">
			  <thead>  
		        <tr>  
			...
			<div id="charges_tb" style="padding:1px;height:auto">  
		        <div>  
		                                查看范围:   
