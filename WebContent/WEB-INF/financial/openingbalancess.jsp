...
<c:choose>
	<c:when test="${customview.cvid!=null && dview!=null}">
		<script>
			var openingbalancess_columns = ${dview};
			var openingbalancess_viewid = ${customview.cvid};
		</script>
	</c:when>
	<c:otherwise>
		<script>
			var openingbalancess_columns = "";
			var openingbalancess_viewid = -1;
		</script>
	</c:otherwise>
</c:choose>
...
<div class="container">
	...
	<div class="easyui-layout" fit="true">
		...
		<div data-options="region:'center',border:false"
			...
			<table id="account_list" class="easyui-datagrid" data-options="fit:true,fitColumns:true" toolbar="#openingbalancess_tb">
			  <thead>  
		        <tr>  
		            <th field="ck" checkbox="true"></th>  
		            <th field="itemid" >应收款编号 </th>  
		            <th field="productid" >应收金额 </th>  
		            <th field="listprice" align="right" >应收日期 </th>  
		            <th field="unitcost" align="right" >是否收款 </th>  
		            <th field="attr1" >客户 </th>  
		            <th field="status" >合同订单 </th>  
		        </tr>  
		    </thead> 
			</table>
			<div id="openingbalancess_tb" style="padding:1px;height:auto">  
			    <div>  
			                            查看范围:   
