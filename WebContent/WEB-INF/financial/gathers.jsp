...
<c:choose>
	<c:when test="${customview.cvid!=null && dview!=null}">
		<script>
			var gathers_columns = ${dview};
			var gathers_viewid = ${customview.cvid};
		</script>
	</c:when>
	<c:otherwise>
		<script>
			var gathers_columns = "";
			var gathers_viewid = -1;
		</script>
	</c:otherwise>
</c:choose>
...
<div class="container">
	...
	<div class="easyui-layout" fit="true">
		...
		<div data-options="region:'center',border:false"
			...
			<table id="account_list" class="easyui-datagrid" data-options="fit:true,fitColumns:true" toolbar="#gathers_tb">
			  <thead>  
		        <tr>  
			...
			<div id="gathers_tb" style="padding:1px;height:auto">  
			    <div>  
			                            查看范围:   
