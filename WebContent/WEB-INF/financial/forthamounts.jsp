...
<c:choose>
	<c:when test="${customview.cvid!=null && dview!=null}">
		<script>
			var forthamounts_columns = ${dview};
			var forthamounts_viewid = ${customview.cvid};
		</script>
	</c:when>
	<c:otherwise>
		<script>
			var forthamounts_columns = "";
			var forthamounts_viewid = -1;
		</script>
	</c:otherwise>
</c:choose>
...
<div class="container">
	...
	<div class="easyui-layout" fit="true">
		...
		<div data-options="region:'center',border:false"
			...
			<table id="account_list" class="easyui-datagrid" data-options="fit:true,fitColumns:true,method:'get'" toolbar="#forthamounts_tb"
					url="resources/test/datagrid17_data.txt"  rownumbers="true" showFooter="true">
				<thead>
					<tr>
						<th field="name">Product Name</th>
						<th field="price" align="right">Unit Price</th>
					</tr>
				</thead>
			</table>
			</table>
			<div id="forthamounts_tb" style="padding:1px;height:auto">  
			    <div>  
			                            查看范围:   
