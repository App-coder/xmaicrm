...
<script type="text/javascript" src="resources/desktop/module/charges/index.js"></script>
</head>
<body id="wrap">
${navbar }
<div class="hidden">
...
${ptb.parenttabLabel }&gt;<a href="crm/module/${fn:toLowerCase(entityname.modulename) }/index?ptb=${ptb.parenttabid }">${tab.tablabel}</a>
	...
	<div class="d_view ">
			...
			<a class="easyui-linkbutton" data-options="plain:true" iconCls="icon-edit" onclick="batchCharges()" >批量收款</a>
