...
<script type="text/javascript" src="resources/desktop/module/noteplans/index.js"></script>
</head>
<body id="wrap">
${navbar }
<div class="hidden">
...
${ptb.parenttabLabel }&gt;<a href="crm/module/${fn:toLowerCase(entityname.modulename) }/index?ptb=${ptb.parenttabid }">${tab.tablabel}</a>
	...
	<div class="d_view ">
			...
			查看范围：<select class="easyui-combotree" style="width:200px;" data-options="url:'crm/module/noteplans/getCondition'"></select>
