...
<body id="wrap">
	...
	<div id="main">
		...
		<fieldset class="mgb_10" >
			<legend>本周计划：（由上周拟定）</legend>
			<table class="tab_form">
				<tr>
					<td width="10%" valign="top" class="edittd3">本周计划</td>
					<td colspan="3"></td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset class="mgb_10" >
			...
			<table class="tab_form">
				<tr>
					<td width="10%" valign="top" class="edittd3">本周总结</td><td width="40%">
					<textarea ></textarea>
					</td>
					<td width="10%" valign="top" class="edittd3">下周计划</td><td width="40%">
					<textarea ></textarea>
					</td>
				</tr>
			</table>
		...
		<iframe width="100%" height="650px"  frameborder="0" src="crm/module/calendar/week" ></iframe>
