...
<script type="text/javascript" src="resources/desktop/module/products/index.js"></script>
</head>
<body id="wrap">
${navbar }
<div class="hidden">
...
<table style="width:100%;">
	<tr>
		<td style="width:200px;vertical-align: top;padding:10px;" valign="top"><ul id="catalog" class="easyui-tree" url="crm/module/catalogs/getCatalogAll" method="get" lines="true" ></ul></td>
		<td valign="top">
