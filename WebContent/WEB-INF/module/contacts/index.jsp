...
<script type="text/javascript" src="resources/desktop/module/contacts/index.js"></script>
</head>
<body id="wrap">
${navbar }
<div class="hidden">
...
${ptb.parenttabLabel }&gt;<a href="crm/module/${fn:toLowerCase(entityname.modulename) }/index?ptb=${ptb.parenttabid }">${tab.tablabel}</a>
	...
	<div class="d_view ">
			...
			查看范围：<select class="easyui-combotree" style="width:200px;" data-options="url:'crm/module/contacts/getCondition'"></select>
			...
			<a class="easyui-linkbutton" data-options="plain:true" iconCls="icon-import" >导入</a>	
			...
			<a class="easyui-linkbutton" data-options="plain:true" iconCls="icon-undo" >取消查找</a>		  
			</div>
			<table id="view_list"
