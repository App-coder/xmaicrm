									...
									<td width="12.5%" valign="top">
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													<td valign="top"><a
														href="javascript:tab('自定义共享规则','crm/settings/customsharingdetailview/index')"><img
												...
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('自定义共享规则','crm/settings/customsharingdetailview/index')">自定义共享规则</a></td>
												</tr>
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													...
													<td valign="top"><a
														href="javascript:tab('自定义字段','crm/settings/picklist/index')"><img
															border="0" title="自定义字段" alt="自定义字段"
															src="resources/images/settings/panel/custom.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('自定义字段','crm/settings/picklist/index')">自定义字段</a></td>
												</tr>
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													...
													<td valign="top"><a
														href="javascript:tab('下拉框选项','crm/settings/picklist/index')"><img
															border="0" title="下拉框选项" alt="下拉框选项"
															src="resources/images/settings/panel/picklist.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('下拉框选项','crm/settings/picklist/index')">下拉框选项</a></td>
												</tr>
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													...
													<td valign="top"><a
														href="javascript:tab('页面布局','crm/settings/picklist/index')"><img
															border="0" title="页面布局" alt="页面布局"
															src="resources/images/settings/panel/layout.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('页面布局','crm/settings/picklist/index')">页面布局</a></td>
												</tr>
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													...
													<td valign="top"><a
														href="javascript:tab('全局字段','crm/settings/customtab/index')"><img
															border="0" title="全局字段" alt="全局字段"
															src="resources/images/settings/panel/orgshar.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('全局字段','crm/settings/customtab/index')">全局字段</a></td>
												</tr>
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													...
													<td valign="top"><a
														href="javascript:tab('相关信息','crm/settings/customtab/index')"><img
															border="0" title="相关信息" alt="相关信息"
															src="resources/images/settings/panel/relatedinfo.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('相关信息','crm/settings/customtab/index')">相关信息</a></td>
												</tr>
									...
									<td width="12.5%" valign="top">
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													<td valign="top"><a
														href="javascript:tab('打印模板','crm/settings/multiapprove/index')"><img
															width="48" height="48" border="0"
															src="resources/images/settings/panel/printtemplate.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('打印模板','crm/settings/multiapprove/index')">打印模板</a></td>
												</tr>
											</tbody>
										</table>
									</td>
									...
									<td width="12.5%" valign="top">
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													<td valign="top"><a
														href="javascript:tab('关联产品字段','crm/settings/multiapprove/index')"><img
															width="48" height="48" border="0"
															src="resources/images/settings/panel/productfield.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('关联产品字段','crm/settings/multiapprove/index')">关联产品字段</a></td>
												</tr>
											</tbody>
										</table>
									</td>
									...
									<td width="12.5%" valign="top">
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													<td valign="top"><a
														href="javascript:tab('审批流程','crm/settings/multiapprove/index')"><img
															width="48" height="48" border="0"
															src="resources/images/settings/panel/approvelist.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('审批流程','crm/settings/multiapprove/index')">审批流程</a></td>
												</tr>
											</tbody>
										</table>
									</td>
									...
									<td width="12.5%" valign="top">
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													<td valign="top"><a
														href="javascript:tab('级联字段','crm/settings/multiapprove/index')"><img
															width="48" height="48" border="0"
															src="resources/images/settings/panel/relatedfield.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('级联字段','crm/settings/multiapprove/index')">级联字段</a></td>
												</tr>
											</tbody>
										</table>
									</td>
									...
									<td width="12.5%" valign="top">
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													<td valign="top"><a
														href="javascript:tab('相关模块字段','crm/settings/multiapprove/index')"><img
															width="48" height="48" border="0"
															src="resources/images/settings/panel/productfield.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('相关模块字段','crm/settings/multiapprove/index')">相关模块字段</a></td>
												</tr>
											</tbody>
										</table>
									</td>									
									...
									<td width="12.5%" valign="top">
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													<td valign="top"><a
														href="javascript:tab('数据库备份','crm/settings/dbbackup/index')"><img
															border="0" title="数据库备份" alt="数据库备份"
															src="resources/images/settings/panel/dbbackup.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('数据库备份','crm/settings/dbbackup/index')">数据库备份</a></td>
									...
									<td width="12.5%" valign="top">
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													<td valign="top"><a
														href="javascript:tab('短信通道','crm/settings/messageconfig/index')"><img
															border="0" title="短信通道" alt="短信通道"
															src="resources/images/settings/panel/ico_mobile.gif"></a></td>
												</tr>
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('短信通道','crm/settings/messageconfig/index')">短信通道</a></td>
												</tr>
									...
									<td width="12.5%" valign="top">
										...
										<table width="100%" class="tab_center" cellspacing="0"
											...
											<tbody>
												<tr>
													<td valign="top"><a
														href="javascript:tab('回收站','crm/settings/recyclebin/index')"><img
												...
												<tr>
													<td valign="top" class="big"><a
														href="javascript:tab('回收站','crm/settings/recyclebin/index')">回收站</a></td>
