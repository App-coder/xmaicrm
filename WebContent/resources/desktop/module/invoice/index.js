...
function add(){
    window.location.href="crm/module/invoice/showedit?recordid=0&ptb="+ptb+"&module="+entitytype;
}
function edit(){
    var selected = $('#view_list').datagrid("getSelected");
    if(selected){
	window.location.href="crm/module/invoice/showedit?recordid="+selected.accountid+"&ptb="+ptb+"&module="+entitytype;
    }else{
	message("请选择记录！");
    }
}
function view(){
    var selected = $('#view_list').datagrid("getSelected");
    if(selected){
	window.location.href="crm/module/invoice/view?recordid="+selected.accountid+"&ptb="+ptb+"&module="+entitytype;
    }else{
	message("请选择记录！");
    }    
}
