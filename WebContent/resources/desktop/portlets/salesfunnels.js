...
function init_salesfunnels(){
	...
	var xmlstr = "<chart caption='' subcaption='' decimals='1' baseFontSize='12' isSliced='1' streamlinedData='0' isHollow='0' bgColor='EAEAEA' showBorder='0' formatNumberScale='0'>";
	...
	charts.render("portlets_salesfunnels");	
    },'json');
}