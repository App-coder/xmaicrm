...
(function($) {
	...
	if (_1c.options.href && (!_1c.isLoaded || !_1c.options.cache)) {
		...
		_1e.html($("<div class=\"panel-loading\"></div>").html(
			_1c.options.loadingMessage));
	    }
	    $.ajax({
	...
	var _38 = _36.children("div.panel-header")
	...
	var _3f = _3d.children("div.panel-header")
		.find("a.panel-tool-collapse");
	...
	var t = $(_66);
	return $.extend({}, $.parser.parseOptions(_66, [ "id", "width",
