...
@Controller
@RequestMapping(value = "crm/module/cares")
public class XmCareController extends BaseController{
	...
	public String index(int ptb,ModelMap modelMap) throws UnsupportedEncodingException{
		ActionUtil.setTitle("Cares", ptb, modelMap, this.moduleUtil);
		return "module/cares/index";
	}
	...
	public String getCondition(){
		...
		myaccount.setId("-1");
		myaccount.setText("我的客户关怀");
		cbos.add(myaccount);
		
		ComboTree  mycreate = new ComboTree();
		mycreate.setId("-2");
		mycreate.setText("我创建的客户关怀");
		cbos.add(mycreate);
		
		ComboTree  mybranch = new ComboTree();
		mybranch.setId("-3");
		mybranch.setText("下属的客户关怀");
		cbos.add(mybranch);
